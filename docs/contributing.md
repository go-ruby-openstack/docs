...
Contributions are welcome. `go-ruby-openstack/openstack` is built to a small set of
...
The library is in [`github.com/go-ruby-openstack/openstack`](https://github.com/go-ruby-openstack/openstack).
This documentation site is in [`github.com/go-ruby-openstack/docs`](https://github.com/go-ruby-openstack/docs).
