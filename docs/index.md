# go-ruby-openstack documentation

**Ruby-facing OpenStack client over gophercloud (CGO=0).**

`go-ruby-openstack/openstack` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `openstack`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `openstack`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`openstack`](https://github.com/go-ruby-openstack/openstack) | the library — Ruby's `openstack` in pure Go |
| [`docs`](https://github.com/go-ruby-openstack/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-openstack.github.io`](https://github.com/go-ruby-openstack/go-ruby-openstack.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-openstack/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-openstack/openstack](https://github.com/go-ruby-openstack/openstack).
